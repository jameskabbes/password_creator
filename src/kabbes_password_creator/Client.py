...
class Client( kabbes_menu.Menu ):
    ...
    def gen_word_password( self, **override_kwargs ):
        ...
        kwargs = ps.merge_dicts( self.cfg.gen.__dict__.copy(), kwargs, override_kwargs )

        words = self.cfg.words.Path.read().split('\n')
        words_to_use = []
    ...
    def gen_random_password( self, **override_kwargs ):
        ...
        default_kwargs = {}
        kwargs = ps.merge_dicts( self.cfg.gen.__dict__.copy(), default_kwargs, override_kwargs )
